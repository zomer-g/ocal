    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-lg text-gray-700 space-y-4">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            להציג לצד הפגישות גם את <strong>הוצאות "קשר עם הציבור"</strong> של חברי
            הכנסת — לראות באותו תאריך גם מה הם עשו וגם על מה הוציאו כספי ציבור.
          </li>
        </ul>
        ...
        <p>
          חברי הכנסת זכאים להחזר הוצאות עבור פעילותם מול הבוחרים — דברים כמו פלאפון,
          הדפסות, אירועים, מתנות וכדומה. הכנסת מפרסמת מדי רבעון/שנה דוחות מפורטים של
          ההוצאות הללו לכל חבר כנסת. שילבנו את הדוחות הללו כשכבת מידע נוספת בפלטפורמה,
          כך שלצד יומן הפגישות של חבר הכנסת ניתן לראות גם מה הוא צרך מתקציב הציבור
          באותם ימים.
        </p>
        <ul className="list-disc list-inside space-y-2">
          <li>
            <strong>מקור הנתונים</strong>: דוחות הוצאות "קשר עם הציבור" כפי שמפורסמים
            על ידי הכנסת בקבצי Excel רשמיים (החל משנת 2024).
          </li>
          <li>
            <strong>שיוך לבעל היומן</strong>: כל הוצאה משויכת אוטומטית לחבר הכנסת
            המתאים לפי שם, מתוך מאגר האנשים הפנימי. שמות שלא נמצאה להם התאמה נוספים
            למאגר באופן אוטומטי.
          </li>
          <li>
            <strong>תצוגה</strong>: שכבת ההוצאות מופעלת כברירת מחדל, וניתן לכבות אותה
            ברשימת היומנים בצד המסך — ממש כמו כל יומן אחר. שורות הוצאה מוצגות בצבע
            ענבר ובאייקון ייעודי כדי להבדיל אותן ויזואלית מפגישות.
          </li>
          <li>
            <strong>מגבלות</strong>: הקבצים הרשמיים אינם כוללים קישור לחשבונית סרוקה
            (השדה ריק במקור), ושמות הספקים מופיעים כפי שדווחו. ייתכנו אי-התאמות בשמות
            של חברי הכנסת לבין הרישום ביומן — נשמח לדיווחים על מקרים כאלה.
          </li>
        </ul>
